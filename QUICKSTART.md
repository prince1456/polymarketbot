...
```env
PERCENTAGE_ALLOCATION=0.01  # 1% per trade
MAX_TRADE_SIZE=10           # $10 max
DAILY_SPENDING_LIMIT=50     # $50 per day
```

### Moderate
```env
PERCENTAGE_ALLOCATION=0.05  # 5% per trade
MAX_TRADE_SIZE=100          # $100 max
DAILY_SPENDING_LIMIT=500    # $500 per day
```

### Aggressive (Use with caution!)
```env
PERCENTAGE_ALLOCATION=0.10  # 10% per trade
